...
CREATE TABLE tipoUsuario(
	...
	nomeTipo varchar(22) not null unique
);
GO
...
CREATE TABLE pai(
	...
	cpfPai varchar(60) not null unique
);
GO
...
CREATE TABLE crianca(
	...
	cpfCrianca varchar(60) not null unique,
	municipioNascimento varchar(60) not null,
